...
- [claude-mem](https://github.com/thedotmack/claude-mem) - Persistent memory compression system for Claude Code: captures tool-usage observations, generates semantic summaries, and surfaces them in future sessions so project context survives across restarts. *By [@thedotmack](https://github.com/thedotmack)*

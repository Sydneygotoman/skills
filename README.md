...
- [ruflo](https://github.com/ruvnet/ruflo) - AI agent orchestration platform for Claude Code: multi-agent swarm coordination, persistent memory, and self-learning hooks. Install with `npx ruflo@latest init wizard`.

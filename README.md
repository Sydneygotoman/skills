...
- [graphify](https://github.com/Graphify-Labs/graphify) - Maps a project (code, docs, PDFs, images, video) into a local-first knowledge graph via tree-sitter AST parsing, so you query it with `graphify query/path/explain` instead of grepping through files. *By [@Graphify-Labs](https://github.com/Graphify-Labs)*

...
- [Task Observer](./task-observer/) - Meta-skill that watches work sessions to spot repeating patterns worth turning into new skills and to suggest improvements to existing ones, including itself. Also known as "One Skill to Rule Them All." *By [Eoghan Henn](https://github.com/rebelytics/one-skill-to-rule-them-all)*

...
- [OpenMontage](https://github.com/calesthio/OpenMontage) - Open-source, agentic video production system that turns your AI coding assistant into a full video studio: research, scripting, asset generation, editing, and Remotion/HyperFrames composition, driven by pipeline manifests and stage-director skills. *By [@calesthio](https://github.com/calesthio)*

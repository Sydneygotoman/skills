...
- [Claude SEO](https://github.com/AgriciDaniel/claude-seo) - Open-source SEO analysis plugin for Claude Code running 25 sub-skills and 18 specialist agents in parallel across technical SEO, content quality (E-E-A-T), Schema.org markup, AI search optimization (GEO), local SEO, and e-commerce SEO. Manual install: `git clone --depth 1 https://github.com/AgriciDaniel/claude-seo.git && bash claude-seo/install.sh`. *By [@AgriciDaniel](https://github.com/AgriciDaniel)*

...
- [Obsidian Vault Manager](./obsidian/) - Builds and maintains a local-first Obsidian knowledge vault: capture sources with citations, write connected notes, and answer questions strictly from vault evidence. Adapted from [claude-obsidian](https://github.com/AgriciDaniel/claude-obsidian).
